...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter city, you want to know the current weather: ");
        ...
        System.out.println(String.format("Name: %s\n" +
                        ...
                        "Area: %f", chosenCity.getName(), chosenCity.getAdministrativeArea(), chosenCity.getNumberOfCitizens(),
                chosenCity.getYearOfFound(), chosenCity.getArea()));
        System.out.println("\nCurrent weather in " + chosenCity.getName());
        System.out.println(weatherForecaster.forecast(chosenCity));
